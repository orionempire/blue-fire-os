...
void initialize_paging() {
	...
	extern u32int KERNEL_TEXT, KERNEL_END_TEXT;
	// Declared in assembly/exit.asm
	extern u32int __task_exit_point;
	...
	*VIRT_TO_PDE_ADDR( (u32int)&__task_exit_point ) |= P_USER;
	*VIRT_TO_PTE_ADDR( (u32int)&__task_exit_point ) |= P_USER;
